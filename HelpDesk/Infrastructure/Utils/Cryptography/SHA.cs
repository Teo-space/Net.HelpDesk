using Infrastructure.Utils.Cryptography.Exceptions;
...
namespace Infrastructure.Utils.Cryptography
{
    public static class SHA
    {
        ...
        public static string SHA512(string data)
        {
            ...
            .ComputeHash(Utils.Serialization.Encoding.GetBytes(data))).Replace("-", null);
        }
        ...
        public static string SHA256(string data)
        {
            ...
            return BitConverter.ToString(SHA256Provider
                .ComputeHash(Infrastructure.Utils.Serialization.Encoding.GetBytes(data))).Replace("-", null);
        }
